...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        <b>Class:</b> Backend Engineer<br />
        <b>Guild:</b> SMTS @ Salesforce<br />
        <b>Special ability:</b> Making complex systems boringly reliable<br />
        <b>Build style:</b> APIs, automation, observability, applied AI<br />
        <b>Alignment:</b> Open source
      </p>
    </td>
    <td width="50%" valign="top">
      <h3>ACTIVE QUEST LOG</h3>
      <p>
        ⚡ Build practical AI tools, not demos<br />
        🛡️ Design resilient, observable services<br />
        📦 Ship focused packages with sharp APIs<br />
        🧪 Learn in public through useful experiments
      </p>
    </td>
  </tr>
</table>

> **SYSTEM STATUS:** Online. Currently turning backend problems, developer friction, and suspiciously ambitious side quests into shipped software.
...
<table>
  <tr>
    <td align="center" width="33%">
      <h3>💘 DateSense</h3>
      <p><b>Genre:</b> AI conversation analyzer</p>
    ...
    <td align="center" width="33%">
      ...
      <p><b>Genre:</b> AI knowledge quest</p>
    ...
    <td align="center" width="33%">
      ...
      <p><b>Genre:</b> Interactive learning</p>
...
<details open>
<summary><b>Press to inspect collected power-ups</b></summary>
<br />
...
| [**git-history-ui**](https://www.npmjs.com/package/git-history-ui) | Local-first Git investigation, portable reports, and PR impact automation | ![version](https://img.shields.io/npm/v/git-history-ui?style=flat-square&color=6C63FF) | ![downloads](https://img.shields.io/npm/dt/git-history-ui?style=flat-square&color=00BFA6&label=downloads) |
...
<sub>Built one side quest at a time by <a href="https://github.com/beingmartinbmc">@beingmartinbmc</a>.</sub>
